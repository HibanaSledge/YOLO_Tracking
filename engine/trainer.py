...
from ultralytics.utils.debug_vis import debug_enabled, set_debug_context
            ...
            for i, batch in pbar:
                ...
                try:
                    with autocast(self.amp):
                        ...
                        if debug_enabled(self.args) and RANK in {-1, 0}:
                            set_debug_context(self.model, self.save_dir, "train", ni, epoch + 1)
